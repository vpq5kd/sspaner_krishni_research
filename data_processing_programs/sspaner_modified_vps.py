...
def make_violin_plot(column):
    ...
    plot_df = df[df["CT_Group"] == "Delivered"]
    ...
    plt.title(f"{column_title_dict[column]} Distribution for Each Organ Amongst Delivered CBCTs")
    plt.ylim(-0.10,2)
...
def main():
    ...
    '''
    make_violin_plot("FractionOverlap")
